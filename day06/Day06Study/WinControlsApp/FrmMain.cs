namespace WinControlsApp
{
    public partial class FrmMain : Form
    {
        ...
        private void ChangeFont()
        {
            ...
            FontStyle style = FontStyle.Regular;    // 0대신에 Regular

            if (ChkBold.Checked) style |= FontStyle.Bold;   // FontStyle.Regular | FontStyle.Bold => 0000 | 0001 = 0001
            if (ChkItalic.Checked) style |= FontStyle.Italic; // FontStyle.Regular | FontStyle.Bold => 0000 | 0010 = 0011
        ...
        private void BtnModaless_Click(object sender, EventArgs e)
        {
            ...
            frmModaless.BackColor = Color.Gray;
        ...
        private void TreeToList(TreeNode node)
        {
            ...
            item.ImageIndex = 0;    // 아이템의 이미지 인덱스 지정
            LsvDummy.Items.Add(item);
            foreach (TreeNode shubNode in node.Nodes)
            {
                TreeToList(shubNode); // 재귀호출(Recursiv Call)
            }
        }
        ...
        private void BtnOpenimage_Click(object sender, EventArgs e)
        {
            ...
            DlgOpenImage.Filter = "Image Files(*.bmp;*.jpg;*.png)|*.bmg;*.jpg;*.png";
